...
import background from '../assets/language_background.jpg';

const Home = () => {
  const navigate = useNavigate(); // Initialize useNavigate

  const handleGetStarted = () => {
    // Navigate to the signup page or any other page you want
    ...
    <div className="Home">
      ...
      <section
        ...
        style={{
          ...
          backgroundSize: 'cover',
          height: '100vh',
          width: '100vw;' // Ensures the section takes up the full viewport height
        }}
      >
        {/* Transparent Overlay */}
        <div
        ...
        <div className="hero-content" style={{ zIndex: 2, position: 'relative' }}>
          <div className="hero-text" style={{ color: 'white' }}>
            <h2>Connect with Native Speakers</h2>
            <p>Master new languages through chat, voice, and video conversations—anytime, anywhere.</p>
      ...
      <section id="features" className="features">
        ...
        <div className="feature-container">
          <div className="feature">
            <img src={chat} alt="Text Chat" className="feature-img" />
            <h3>🌐 Text Chat</h3>
            <p>Engage in real-time text conversations with native speakers.</p>
          </div>
          <div className="feature">
            <img src={call} alt="Voice Calls" className="feature-img" />
            <h3>📞 Voice Calls</h3>
            <p>Practice your speaking skills with voice calls.</p>
          </div>
          <div className="feature">
            <img src={video} alt="Video Calls" className="feature-img" />
            <h3>📹 Video Calls</h3>
            <p>Enhance your learning experience with video calls.</p>
          </div>
        </div>
      </section>
      <section id="about" className="about">
        <h2>About Fly Lingua</h2>
        <div className="about-grid">
          <div className="about-item">
            <h3> Global Connection</h3>
            <p>Connect with native speakers from over 100 countries to learn authentic languages.</p>
          </div>
          <div className="about-item">
            <h3> Learn Naturally</h3>
            <p>We focus on conversational fluency through real-time interactions, just like talking to a friend.</p>
          </div>
          <div className="about-item">
            <h3> Personalized Learning</h3>
            <p>Choose the pace, topics, and methods that work best for your goals—anytime, anywhere.</p>
          </div>
      ...
      <footer className="contact-footer">
        ...
        <div className="contact-card">
          ...
          <p>Email: <a href="mailto:support@flylingua.com">support@flylingua.com</a></p>
        ...
        <p className="footer-text">© 2025 Language Exchange Platform. All rights reserved.</p>
      </footer>
